...
<template>
  <div class="flex items-center space-x-4 p-4 border-b">
    <img :src="props.item.product.image_url" alt="Product Image" class="w-12 h-12 object-cover rounded-lg">
    <div class="flex-1">
      <h2 class="text-md font-semibold">{{ props.item.product.name }}</h2>
